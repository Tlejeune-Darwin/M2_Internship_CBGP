...
=======
file_path <- file.path(desktop_path, "simulations", "summary_table_all_batches.csv")
>>>>>>> Stashed changes
...
```
```{r}
subset_ref <- reference_table[sample(1:nrow(reference_table), 2000), ]
predictOOB(abcrf_model, refTable = subset_ref, training = TRUE)
