...
model_rf_N_all <- regAbcrf(as.formula(paste(target_param_N, "~ .")), data = learning_data_N_all, ntree = 400)
...
# Regression ABCRF that will predict the values of a parameters from the data base formed by the simulations
model_rf_N_CMR <- regAbcrf(as.formula(paste(target_param_N, "~ .")), data = learning_data_N_CMR, ntree = 400)
...
# Regression ABCRF that will predict the values of a parameters from the data base formed by the simulations
model_rf_N_gen <- regAbcrf(as.formula(paste(target_param_N, "~ .")), data = learning_data_N_gen, ntree = 400)
...
# Regression ABCRF that will predict the values of a parameters from the data base formed by the simulations
model_rf_Ne_all <- regAbcrf(as.formula(paste(target_param_Ne, "~ .")), data = learning_data_Ne_all, ntree = 400)
...
# Regression ABCRF that will predict the values of a parameters from the data base formed by the simulations
model_rf_Ne_gen <- regAbcrf(as.formula(paste(target_param_Ne, "~ .")), data = learning_data_Ne_gen, ntree = 400)
...
# Regression ABCRF that will predict the values of a parameters from the data base formed by the simulations
model_rf_Ne_CMR <- regAbcrf(as.formula(paste(target_param_Ne, "~ .")), data = learning_data_Ne_CMR, ntree = 400)
...
# Regression ABCRF that will predict the values of a parameters from the data base formed by the simulations
model_rf_Ne_N <- regAbcrf(as.formula(paste(target_param_Ne_N, "~ .")), data = learning_data_Ne_N, ntree = 400)
...
learning_data_ratio_all <- bind_cols(y = params[[target_param_ratio_all]], stats_table) %>% rename(!!target_param_ratio_all := y)

# Regression ABCRF that will predict the values of a parameters from the data base formed by the simulations
model_rf_ratio_all <- regAbcrf(as.formula(paste(target_param_ratio_all, "~ .")), data = learning_data_ratio_all, ntree = 400)
summary(model_rf_ratio_all)
...
learning_data_ratio_gen <- bind_cols(y = params[[target_param_ratio_gen]], stats_table_Ne) %>% rename(!!target_param_ratio_gen := y)

# Regression ABCRF that will predict the values of a parameters from the data base formed by the simulations
model_rf_ratio_gen <- regAbcrf(as.formula(paste(target_param_ratio_gen, "~ .")), data = learning_data_ratio_gen, ntree = 400)
summary(model_rf_ratio_gen)
...
learning_data_ratio_CMR <- bind_cols(y = params[[target_param_ratio]], stats_table_N) %>% rename(!!target_param_ratio := y)

# Regression ABCRF that will predict the values of a parameters from the data base formed by the simulations
model_rf_ratio_CMR <- regAbcrf(as.formula(paste(target_param_ratio, "~ .")), data = learning_data_ratio_CMR, ntree = 400)
summary(model_rf_ratio_CMR)
